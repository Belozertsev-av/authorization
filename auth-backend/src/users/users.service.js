...
var users_types_1 = require("/~/users/users.types");
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1() {
            this.users = [
                new users_types_1.User("Ivan", "Ivanovich", "iIvanovich@gamil.com", 9110097755, "iVan", "1234"),
                new users_types_1.User("Petr", "Petrov", "pPetrov@gamil.com", 9110086644, "pEtr", "1001"),
            ];
        }
